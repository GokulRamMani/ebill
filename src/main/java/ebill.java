...
public class ebill extends javax.swing.JFrame {
    ...
    int conu;
    String cid;
    public void appendToPrintField(String text) {
    txtprint.setText(txtprint.getText() + text + "\n");
}
    public void print() {
    ...
    appendToPrintField("");
    appendToPrintField("Electricity Billing System");
    appendToPrintField("");
    appendToPrintField("Bill No : - "  + billid);
    appendToPrintField("Customer : - " + customer);
    appendToPrintField("Unit  : - " + conu);
    appendToPrintField("Amount  : - " + gramt);
    appendToPrintField("Thank you Come Again");
}
